            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4><?php echo e($user->batch1); ?></h4>
                                <a href="/attendance/<?php echo e($user->batch1); ?>/create" class="btn btn-default">Upload Attendance</a>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="contact-area">
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4><?php echo e($user->batch2); ?></h4>
                                <a href="/attendance/<?php echo e($user->batch2); ?>/create" class="btn btn-default">Upload Attendance</a>
                            </div>
                        </div>
                    </div>
                </section>        
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lsapp\resources\views/attendance/index.blade.php ENDPATH**/ ?>