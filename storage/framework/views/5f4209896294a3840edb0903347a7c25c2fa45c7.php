...
<body>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php echo Form::open(['action' => 'RelationshipsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']); ?>

            <div class="form-group" style="width:1000px">
                <?php echo e(Form::label('parent_id', 'Parent User ID:')); ?>

                <?php echo e(Form::text('parent_id', '', ['class' => 'form-control', 'placeholder' => 'Parent User ID'])); ?>

            </div>
            <div class="form-group" style="width:1000px">
                <?php echo e(Form::label('student_id', 'Student User ID')); ?>

                <?php echo e(Form::text('student_id', '', [ 'class' => 'form-control', 'placeholder' => 'Student User ID'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lsapp\resources\views/admin/addRelation.blade.php ENDPATH**/ ?>