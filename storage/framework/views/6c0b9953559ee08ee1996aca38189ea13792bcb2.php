                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4><?php echo e($chat->from_name); ?></h4>
                                <p>Posted On:</p><small><?php echo e($chat->created_at); ?></small><br><br><br>
                                <p>Posted By:</p><small><?php echo e($chat->from_user); ?></small>    
                            </div>
                        </div>
                    </div>
                </section>        
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lsapp\resources\views/teacher/chat.blade.php ENDPATH**/ ?>