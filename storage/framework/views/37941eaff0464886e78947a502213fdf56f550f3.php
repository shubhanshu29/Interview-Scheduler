                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                ...
                                <a href="/marks/<?php echo e($user->batch1); ?>/create" class="btn btn-default">Upload Marks</a>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                ...
                                <a href="/marks/<?php echo e($user->batch2); ?>/create" class="btn btn-default">Upload Marks</a>
                            </div>
                        </div>
                    </div>
                </section>        
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lsapp\resources\views/marks/index.blade.php ENDPATH**/ ?>