                    ...
                    <div class="container">
                        <div class="col-12 col-lg-6">
                            <div class="contact--info mt-50 mb-100">
                                <h4><?php echo e($scholarship->name); ?></h4>
                                <p>Marks in previous class: <?php echo e($scholarship->marks); ?></p>
                                <p>Email:</p><small><?php echo e($scholarship->email); ?></small><br><br><br>
                                <p>Request Posted On:<small><?php echo e($scholarship->created_at); ?></small></p>
                                <p>Request Posted By:<small><?php echo e($scholarship->number); ?></small></p>    
                            </div>
                        </div>
                    </div>
                </section>        
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lsapp\resources\views/scholarships/index.blade.php ENDPATH**/ ?>