    ...
    @section('content')
        ...
        {!! Form::open(['action' => 'InterviewsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
            <div class="form-group" style="width:1000px">
                {{Form::label('start_at', 'Start at')}}
                {{Form::text('start_at', '', ['class' => 'form-control', 'placeholder' => 'YYYY-MM-DD HH:MM:SS'])}}
            </div>
            <div class="form-group" style="width:1000px">
                {{Form::label('end_at', 'Ending Time')}}
                {{Form::text('end_at', '', ['class' => 'form-control', 'placeholder' => 'YYYY-MM-DD HH:MM:SS'])}}
            </div>
            <br>
